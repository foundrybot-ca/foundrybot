...
#   - Create bpool & rpool following the Bookworm HOWTO
#   - debootstrap a fresh Bookworm into /mnt/zfs-root
...
ZFS_RELEASE="${ZFS_RELEASE:-bookworm}"
...
### --- STEP 2: Partition disk (Bookworm HOWTO style) -------------------------
